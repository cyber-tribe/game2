...
const STAGES: readonly StageDefinition[] = [
  ...
  { id: "athens-1", place: "アテナイ", god: "アテナ", chapter: "地上編", stage: 1, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "human", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: false, disasterMarkersVisible: true, allowedMiracles: ["shrine", "earthquake", "swamp", "holyWater", "tornado", "firePillar", "plague", "reef", "road", "wall", "megalith", "fungus", "achilles", "flower", "volcano", "whirlpool", "armageddon"] },
  { id: "athens-2", place: "アテナイ", god: "アテナ", chapter: "地上編", stage: 2, terrain: "grass", terrainEditRule: "raiseOnly", enemyPersonality: "balanced", enemySchool: "human", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "swamp", "tornado", "firePillar", "megalith", "fungus", "forest", "flower", "whirlpool"] },
  { id: "athens-3", place: "アテナイ", god: "アテナ", chapter: "地上編", stage: 3, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "human", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: false, disasterMarkersVisible: true, allowedMiracles: ["shrine", "swamp", "holyWater", "lightning", "storm", "wall", "achilles", "forest", "flower", "volcano", "tsunami", "armageddon"] },
  { id: "mycenae-1", place: "ミュケナイ", god: "ディオニュソス", chapter: "地上編", stage: 1, terrain: "desert", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: true, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: false, disasterMarkersVisible: true, allowedMiracles: ["shrine", "holyWater", "road", "wall", "adonis", "flower", "armageddon"] },
  { id: "mycenae-2", place: "ミュケナイ", god: "ディオニュソス", chapter: "地上編", stage: 2, terrain: "desert", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "plant", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "earthquake", "swamp", "tornado", "firePillar", "reef", "adonis", "fireRain", "volcano", "tsunami", "whirlpool", "armageddon"] },
  { id: "mycenae-3", place: "ミュケナイ", god: "ディオニュソス", chapter: "地上編", stage: 3, terrain: "desert", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "plant", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "earthquake", "plague", "hurricane", "megalith", "adonis", "flower", "volcano", "tsunami", "armageddon"] },
  { id: "larissa-1", place: "ラリッサ", god: "ヘパイストス", chapter: "地上編", stage: 1, terrain: "rock", terrainEditRule: "raiseOnly", enemyPersonality: "aggressive", enemySchool: "fire", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "holyWater", "firePillar", "reef", "achilles", "forest", "flower", "fireRain", "whirlpool"] },
  { id: "larissa-2", place: "ラリッサ", god: "ヘパイストス", chapter: "地上編", stage: 2, terrain: "rock", terrainEditRule: "neither", enemyPersonality: "aggressive", enemySchool: "fire", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "tornado", "firePillar", "megalith", "fungus", "forest", "flower", "whirlpool"] },
  { id: "larissa-3", place: "ラリッサ", god: "ヘパイストス", chapter: "地上編", stage: 3, terrain: "rock", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "fire", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "hurricane", "reef", "megalith", "fungus", "armageddon"] },
  { id: "thrace-1", place: "トラキア", god: "デメテル", chapter: "地上編", stage: 1, terrain: "snow", terrainEditRule: "lowerOnly", enemyPersonality: "balanced", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: false, disasterMarkersVisible: false, allowedMiracles: ["earthquake", "swamp", "holyWater", "lightning", "storm", "plague", "megalith", "adonis", "forest", "flower", "volcano", "whirlpool", "armageddon"] },
  { id: "thrace-2", place: "トラキア", god: "デメテル", chapter: "地上編", stage: 2, terrain: "snow", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, enemyPositionsVisible: false, disasterMarkersVisible: true, allowedMiracles: ["shrine", "earthquake", "firePillar", "road", "wall", "adonis", "forest", "flower"] },
  { id: "thrace-3", place: "トラキア", god: "デメテル", chapter: "地上編", stage: 3, terrain: "snow", terrainEditRule: "raiseOnly", enemyPersonality: "balanced", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "reef", "adonis", "tsunami"] },
  { id: "olympus-1", place: "オリュンポス山", god: "ガイア", chapter: "地上編", stage: 1, terrain: "rock", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "earth", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "earthquake", "tornado", "firePillar", "plague", "hurricane", "reef", "road", "wall", "hercules", "forest", "flower", "fireRain", "volcano", "tsunami", "whirlpool", "armageddon"] },
  { id: "olympus-2", place: "オリュンポス山", god: "ガイア", chapter: "地上編", stage: 2, terrain: "rock", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "earth", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "hurricane", "hercules", "tsunami", "armageddon"] },
  { id: "olympus-3", place: "オリュンポス山", god: "ガイア", chapter: "地上編", stage: 3, terrain: "rock", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "earth", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "lightning", "wall", "hercules", "flower", "armageddon"] },
  { id: "artemis-1", place: "月神の宮", god: "アルテミス", chapter: "天上編", stage: 1, terrain: "snow", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "plague", "perseus", "guardian", "armageddon"] },
  { id: "artemis-2", place: "月神の宮", god: "アルテミス", chapter: "天上編", stage: 2, terrain: "snow", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "plant", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "swamp"] },
  { id: "artemis-3", place: "月神の宮", god: "アルテミス", chapter: "天上編", stage: 3, terrain: "snow", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "earthquake", "swamp", "tornado", "firePillar", "reef", "perseus", "guardian", "flower", "fireRain", "volcano", "tsunami", "whirlpool", "armageddon"] },
  { id: "apollo-1", place: "太陽神の宮", god: "アポロン", chapter: "天上編", stage: 1, terrain: "desert", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "fire", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "holyWater", "plague", "flower", "armageddon"] },
  { id: "apollo-2", place: "太陽神の宮", god: "アポロン", chapter: "天上編", stage: 2, terrain: "desert", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "fire", enemyTerritoryEditable: false, bottomlessSwamp: false, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "earthquake", "swamp", "holyWater", "firePillar", "lightning", "storm", "plague", "hurricane", "reef", "road", "wall", "fungus", "achilles", "forest", "flower", "fireRain", "volcano", "tsunami", "whirlpool", "armageddon"] },
  ...
  { id: "hades-1", place: "冥王の宮", god: "ハデス", chapter: "天上編", stage: 1, terrain: "rock", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "earth", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: false, disasterMarkersVisible: true, allowedMiracles: ["shrine", "earthquake", "perseus", "guardian", "volcano"] },
  { id: "hades-2", place: "冥王の宮", god: "ハデス", chapter: "天上編", stage: 2, terrain: "rock", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "earth", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "swamp", "fungus", "achilles", "forest", "flower"] },
  { id: "hades-3", place: "冥王の宮", god: "ハデス", chapter: "天上編", stage: 3, terrain: "rock", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "earth", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, enemyPositionsVisible: false, disasterMarkersVisible: false, allowedMiracles: ["shrine", "firePillar", "lightning", "road", "hercules", "forest"] },
  { id: "zeus-1", place: "オリュンポス神殿", god: "ゼウス", chapter: "天上編", stage: 1, terrain: "rock", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "air", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: false, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "earthquake", "swamp", "firePillar", "lightning", "storm", "reef", "adonis", "fireRain", "volcano", "tsunami", "whirlpool", "armageddon"] },
  { id: "zeus-2", place: "オリュンポス神殿", god: "ゼウス", chapter: "天上編", stage: 2, terrain: "rock", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "air", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: false, rescueAllowed: true, enemyPositionsVisible: true, disasterMarkersVisible: true, allowedMiracles: ["shrine", "lightning", "storm", "hurricane", "odysseus"] },
  { id: "zeus-3", place: "オリュンポス神殿", god: "ゼウス", chapter: "天上編", stage: 3, terrain: "rock", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "air", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: false, rescueAllowed: true, enemyPositionsVisible: false, disasterMarkersVisible: false, allowedMiracles: ["earthquake", "holyWater", "lightning", "storm", "hurricane", "reef", "wall", "fungus", "hercules", "forest", "flower", "fireRain", "volcano"] },
];
