...
const STAGES: readonly StageDefinition[] = [
  { id: "argos-1", place: "アルゴス", god: "プロメテウス", chapter: "地上編", stage: 1, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "fire", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: true, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "firePillar", "perseus", "guardian", "armageddon"] },
  { id: "argos-2", place: "アルゴス", god: "プロメテウス", chapter: "地上編", stage: 2, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "fire", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: true, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "swamp", "firePillar", "lightning", "perseus", "guardian", "armageddon"] },
  { id: "argos-3", place: "アルゴス", god: "プロメテウス", chapter: "地上編", stage: 3, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "fire", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: true, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "earthquake", "swamp", "firePillar", "lightning", "perseus", "guardian", "fireRain", "armageddon"] },
  { id: "sparta-1", place: "スパルタ", god: "ヘルメス", chapter: "地上編", stage: 1, terrain: "grass", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "air", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: true, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "earthquake", "holyWater", "tornado", "odysseus", "fireRain", "armageddon"] },
  { id: "sparta-2", place: "スパルタ", god: "ヘルメス", chapter: "地上編", stage: 2, terrain: "grass", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "air", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "swamp", "holyWater", "tornado", "odysseus", "fireRain", "armageddon"] },
  { id: "sparta-3", place: "スパルタ", god: "ヘルメス", chapter: "地上編", stage: 3, terrain: "grass", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "air", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "lightning", "storm", "odysseus", "armageddon"] },
  { id: "crete-1", place: "クレタ", god: "ステュクス", chapter: "地上編", stage: 1, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "water", enemyTerritoryEditable: true, bottomlessSwamp: false, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "swamp", "firePillar", "adonis", "forest", "fireRain", "whirlpool", "armageddon"] },
  { id: "crete-2", place: "クレタ", god: "ステュクス", chapter: "地上編", stage: 2, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "water", enemyTerritoryEditable: true, bottomlessSwamp: false, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "earthquake", "swamp", "firePillar", "road", "wall", "adonis", "forest", "armageddon"] },
  ...
  { id: "cyprus-1", place: "キプロス", god: "アフロディーテ", chapter: "地上編", stage: 1, terrain: "desert", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "human", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "earthquake", "firePillar", "road", "wall", "megalith", "fungus", "hercules", "forest", "flower", "armageddon"] },
  ...
  { id: "cyprus-3", place: "キプロス", god: "アフロディーテ", chapter: "地上編", stage: 3, terrain: "desert", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "human", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "holyWater", "firePillar", "lightning", "hercules", "whirlpool", "armageddon"] },
  { id: "delos-1", place: "デロス", god: "アレス", chapter: "地上編", stage: 1, terrain: "grass", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "human", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "reef", "helen", "tsunami"] },
  { id: "delos-2", place: "デロス", god: "アレス", chapter: "地上編", stage: 2, terrain: "grass", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "human", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "earthquake", "swamp", "tornado", "firePillar", "reef", "road", "wall", "megalith", "fungus", "helen", "forest", "flower", "fireRain", "tsunami", "whirlpool"] },
  ...
  { id: "athens-1", place: "アテナイ", god: "アテナ", chapter: "地上編", stage: 1, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "human", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "earthquake", "swamp", "holyWater", "tornado", "firePillar", "plague", "reef", "road", "wall", "megalith", "fungus", "achilles", "flower", "volcano", "whirlpool", "armageddon"] },
  { id: "athens-2", place: "アテナイ", god: "アテナ", chapter: "地上編", stage: 2, terrain: "grass", terrainEditRule: "raiseOnly", enemyPersonality: "balanced", enemySchool: "human", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "swamp", "tornado", "firePillar", "megalith", "fungus", "forest", "flower", "whirlpool"] },
  { id: "athens-3", place: "アテナイ", god: "アテナ", chapter: "地上編", stage: 3, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "human", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "swamp", "holyWater", "lightning", "storm", "wall", "achilles", "forest", "flower", "volcano", "tsunami", "armageddon"] },
  { id: "mycenae-1", place: "ミュケナイ", god: "ディオニュソス", chapter: "地上編", stage: 1, terrain: "desert", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: true, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "holyWater", "road", "wall", "adonis", "flower", "armageddon"] },
  { id: "mycenae-2", place: "ミュケナイ", god: "ディオニュソス", chapter: "地上編", stage: 2, terrain: "desert", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "plant", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "earthquake", "swamp", "tornado", "firePillar", "reef", "adonis", "fireRain", "volcano", "tsunami", "whirlpool", "armageddon"] },
  { id: "mycenae-3", place: "ミュケナイ", god: "ディオニュソス", chapter: "地上編", stage: 3, terrain: "desert", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "plant", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "earthquake", "plague", "hurricane", "megalith", "adonis", "flower", "volcano", "tsunami", "armageddon"] },
  { id: "larissa-1", place: "ラリッサ", god: "ヘパイストス", chapter: "地上編", stage: 1, terrain: "rock", terrainEditRule: "raiseOnly", enemyPersonality: "aggressive", enemySchool: "fire", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "holyWater", "firePillar", "reef", "achilles", "forest", "flower", "fireRain", "whirlpool"] },
  { id: "larissa-2", place: "ラリッサ", god: "ヘパイストス", chapter: "地上編", stage: 2, terrain: "rock", terrainEditRule: "neither", enemyPersonality: "aggressive", enemySchool: "fire", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "tornado", "firePillar", "megalith", "fungus", "forest", "flower", "whirlpool"] },
  { id: "larissa-3", place: "ラリッサ", god: "ヘパイストス", chapter: "地上編", stage: 3, terrain: "rock", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "fire", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "hurricane", "reef", "megalith", "fungus", "armageddon"] },
  { id: "thrace-1", place: "トラキア", god: "デメテル", chapter: "地上編", stage: 1, terrain: "snow", terrainEditRule: "lowerOnly", enemyPersonality: "balanced", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["earthquake", "swamp", "holyWater", "lightning", "storm", "plague", "megalith", "adonis", "forest", "flower", "volcano", "whirlpool", "armageddon"] },
  { id: "thrace-2", place: "トラキア", god: "デメテル", chapter: "地上編", stage: 2, terrain: "snow", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "earthquake", "firePillar", "road", "wall", "adonis", "forest", "flower"] },
  { id: "thrace-3", place: "トラキア", god: "デメテル", chapter: "地上編", stage: 3, terrain: "snow", terrainEditRule: "raiseOnly", enemyPersonality: "balanced", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "reef", "adonis", "tsunami"] },
  { id: "olympus-1", place: "オリュンポス山", god: "ガイア", chapter: "地上編", stage: 1, terrain: "rock", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "earth", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "earthquake", "tornado", "firePillar", "plague", "hurricane", "reef", "road", "wall", "hercules", "forest", "flower", "fireRain", "volcano", "tsunami", "whirlpool", "armageddon"] },
  { id: "olympus-2", place: "オリュンポス山", god: "ガイア", chapter: "地上編", stage: 2, terrain: "rock", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "earth", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "hurricane", "hercules", "tsunami", "armageddon"] },
  { id: "olympus-3", place: "オリュンポス山", god: "ガイア", chapter: "地上編", stage: 3, terrain: "rock", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "earth", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "lightning", "wall", "hercules", "flower", "armageddon"] },
  { id: "artemis-1", place: "月神の宮", god: "アルテミス", chapter: "天上編", stage: 1, terrain: "snow", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "plague", "perseus", "guardian", "armageddon"] },
  { id: "artemis-2", place: "月神の宮", god: "アルテミス", chapter: "天上編", stage: 2, terrain: "snow", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "plant", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "swamp"] },
  { id: "artemis-3", place: "月神の宮", god: "アルテミス", chapter: "天上編", stage: 3, terrain: "snow", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "plant", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "earthquake", "swamp", "tornado", "firePillar", "reef", "perseus", "guardian", "flower", "fireRain", "volcano", "tsunami", "whirlpool", "armageddon"] },
  { id: "apollo-1", place: "太陽神の宮", god: "アポロン", chapter: "天上編", stage: 1, terrain: "desert", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "fire", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "holyWater", "plague", "flower", "armageddon"] },
  { id: "apollo-2", place: "太陽神の宮", god: "アポロン", chapter: "天上編", stage: 2, terrain: "desert", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "fire", enemyTerritoryEditable: false, bottomlessSwamp: false, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "earthquake", "swamp", "holyWater", "firePillar", "lightning", "storm", "plague", "hurricane", "reef", "road", "wall", "fungus", "achilles", "forest", "flower", "fireRain", "volcano", "tsunami", "whirlpool", "armageddon"] },
  ...
  { id: "hera-1", place: "天界王妃の宮", god: "ヘラ", chapter: "天上編", stage: 1, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "human", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "holyWater", "lightning", "plague", "odysseus"] },
  { id: "hera-2", place: "天界王妃の宮", god: "ヘラ", chapter: "天上編", stage: 2, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "human", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "firePillar", "storm", "megalith", "fungus", "odysseus", "forest", "flower", "whirlpool", "armageddon"] },
  { id: "hera-3", place: "天界王妃の宮", god: "ヘラ", chapter: "天上編", stage: 3, terrain: "grass", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "human", enemyTerritoryEditable: true, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: false, allowedMiracles: ["shrine", "swamp", "fungus", "odysseus", "forest", "flower"] },
  { id: "poseidon-1", place: "海王の宮", god: "ポセイドン", chapter: "天上編", stage: 1, terrain: "snow", terrainEditRule: "both", enemyPersonality: "defensive", enemySchool: "water", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "earthquake", "swamp", "holyWater", "firePillar", "lightning", "storm", "plague", "hurricane", "reef", "road", "wall", "megalith", "fungus", "helen", "forest", "flower", "fireRain", "volcano", "tsunami", "whirlpool"] },
  ...
  { id: "hades-1", place: "冥王の宮", god: "ハデス", chapter: "天上編", stage: 1, terrain: "rock", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "earth", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "earthquake", "perseus", "guardian", "volcano"] },
  { id: "hades-2", place: "冥王の宮", god: "ハデス", chapter: "天上編", stage: 2, terrain: "rock", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "earth", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "swamp", "fungus", "achilles", "forest", "flower"] },
  { id: "hades-3", place: "冥王の宮", god: "ハデス", chapter: "天上編", stage: 3, terrain: "rock", terrainEditRule: "both", enemyPersonality: "aggressive", enemySchool: "earth", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: true, rescueAllowed: true, allowedMiracles: ["shrine", "firePillar", "lightning", "road", "hercules", "forest"] },
  { id: "zeus-1", place: "オリュンポス神殿", god: "ゼウス", chapter: "天上編", stage: 1, terrain: "rock", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "air", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: false, rescueAllowed: true, allowedMiracles: ["shrine", "earthquake", "swamp", "firePillar", "lightning", "storm", "reef", "adonis", "fireRain", "volcano", "tsunami", "whirlpool", "armageddon"] },
  { id: "zeus-2", place: "オリュンポス神殿", god: "ゼウス", chapter: "天上編", stage: 2, terrain: "rock", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "air", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: false, rescueAllowed: true, allowedMiracles: ["shrine", "lightning", "storm", "hurricane", "odysseus"] },
  { id: "zeus-3", place: "オリュンポス神殿", god: "ゼウス", chapter: "天上編", stage: 3, terrain: "rock", terrainEditRule: "both", enemyPersonality: "balanced", enemySchool: "air", enemyTerritoryEditable: false, bottomlessSwamp: true, openTerraforming: false, sprogAllowed: false, rescueAllowed: true, allowedMiracles: ["earthquake", "holyWater", "lightning", "storm", "hurricane", "reef", "wall", "fungus", "hercules", "forest", "flower", "fireRain", "volcano"] },
];
